        ...
        for entidades in tracker.latest_message['entities']:
            if entidades['entity'] == 'tema':
                ...
                if tema_elegido in ALLOWED_TEMAS:
                   ...
                   # dispatcher.utter_message(response="utter_temario")
